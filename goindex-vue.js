self.props = {
  ...
  // https://github.com/WIKIANOW/gdindex-fns/tree/production/themes
...
(function () {
  ...
  async function onGet(request) {
    ...
    if (path.startsWith('/~_~_goindex/resources/')) {
      ...
      const r = await fetch(`https://raw.githubusercontent.com/WIKIANOW/gdindex-fns/production/themes/material-vue-${self.props.ui}/${remain}`);
